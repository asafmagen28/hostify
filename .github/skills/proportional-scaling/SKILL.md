...
| vw target formula | `(figma_size / 1920) * 100` (Figma viewport = 1920px wide) |
| vh target formula | `(figma_size / 1080) * 100` (Figma viewport = 1080px tall) |
...
5. **Pixel-perfect reference viewport**: `1920×1080` — all Figma measurements are taken at
   this resolution. Scale from here when computing `vw`/`vh` targets.

6. **Test matrix** (use DevTools responsive mode):
   - Widths: 1280, 1440, 1920
   - Heights: 768, 900, 1080
   - **Pixel-perfect baseline**: 1920×1080
