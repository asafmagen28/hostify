...
export default function PartnersContent() {
  ...
  return (
    <div>
      ...
      {/* Bottom panels */}
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_clamp(300px,22.9vw,440px)] gap-5 mb-[clamp(12px,2vh,24px)]">
        <div
      ...
      <div>
        ...
        >
          <button
            onClick={() => {
              navigator.clipboard
                .writeText("https://hostify.co.il/ref/eldad-xxxxxxxxxxxxxxxxx")
                .then(() => {
                  setCopied(true);
      ...
      {/* Referrals table */}
      <div className="mt-[clamp(20px,2.5vh,40px)]">
        <h2
          className="font-polin font-extrabold text-navy text-right mb-4"
          style={{ fontSize: "clamp(20px,1.9vw,36px)" }}
        >
          כל ההפניות שלך
        </h2>
        <ReferralsTable />
      ...
      <div className="flex-1 flex flex-col items-center justify-center gap-4 min-h-0">
        <div className="relative flex items-center justify-center flex-shrink-0">
          <Image
            ...
            width={182}
            height={182}
            style={{ width: "clamp(110px, 9.5vw, 182px)", height: "clamp(110px, 9.5vw, 182px)" }}
          />
        ...
        <div className="flex items-center justify-center gap-6 w-full px-2 flex-shrink-0">
          <div className="flex items-center gap-2">
            <Image src={PARTNERS_IDENTIFIER_1} alt="" width={16} height={16} className="flex-shrink-0" />
            <span className="font-polin text-[13px] text-navy">65% לורם</span>
          </div>
          <div className="flex items-center gap-2">
            <Image src={PARTNERS_IDENTIFIER_2} alt="" width={16} height={16} className="flex-shrink-0" />
...
const REFERRALS: ReferralRow[] = [
  { date: "06.02.2026", plan: "גוניור", amount: "₪39.00/ לחודש", commission: "₪3.00", active: true },
  { date: "06.02.2026", plan: "גוניור", amount: "₪39.00/ לחודש", commission: "₪3.00", active: true },
  { date: "06.02.2026", plan: "גוניור", amount: "₪39.00/ לחודש", commission: "₪3.00", active: true },
  { date: "06.02.2026", plan: "גוניור", amount: "₪39.00/ לחודש", commission: "₪3.00", active: false },
  { date: "06.02.2026", plan: "גוניור", amount: "₪39.00/ לחודש", commission: "₪3.00", active: true },
  { date: "06.02.2026", plan: "גוניור", amount: "₪39.00/ לחודש", commission: "₪3.00", active: true },
  { date: "06.02.2026", plan: "גוניור", amount: "₪39.00/ לחודש", commission: "₪3.00", active: true },
  { date: "06.02.2026", plan: "גוניור", amount: "₪39.00/ לחודש", commission: "₪3.00", active: true },
...
const TABLE_COLS = ["תאריך הצטרפות", "חבילה/שירות", "סכום", "עמלה", "סטטוס"];
